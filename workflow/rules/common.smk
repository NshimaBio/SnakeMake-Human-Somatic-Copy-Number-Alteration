...
# def get_picard_intervals(wildcards,defualt=""):
    # g=wildcards.get("g","")
    # if g == "T":
    #     return "results/called/preprocessed.interval_list"
    # elif g == "N":
    #     return "results/called/RemoveChrSex.interval_list"
    # elif (g == "") & (config["fastq"]["restrict_regions"]!=""):
    #     return "results/called/bed.interval_list"
    # if wildcards.get("g",""):
    # else:
    #     return defualt
